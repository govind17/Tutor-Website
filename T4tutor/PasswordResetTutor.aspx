<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PasswordResetTutor.aspx.cs" Inherits="PasswordReset" %>
...
&nbsp;
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox_EmailId" ErrorMessage="Please Enter an EmailId to search"></asp:RequiredFieldValidator>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBox_NewPassword" ErrorMessage="Enter password"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
