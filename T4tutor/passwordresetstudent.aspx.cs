...
public partial class passwordresetstudent : System.Web.UI.Page
{
    ...
    {
        SqlCommand cmd = new SqlCommand("select count(*) from student where eid = @eid", con);
        con.Open();
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        {
            SqlCommand cmd1 = new SqlCommand("UPDATE Student SET password = @pas where eid = @eid", con);
            con.Open();
